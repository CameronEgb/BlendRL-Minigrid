...
# Select NPZ file (default to full dataset with flags)
npz_filename = os.environ.get("MIMIC_DATASET_NAME", "mimic_lazy_0_interventions_flag.npz")
if len(sys.argv) > 1:
...
if not os.path.exists(npz_path):
    ...
    for alt in ["mimic_lazy_0_interventions_flag.npz", "mimic_lazy_0_interventions_balanced.npz", "mimic_lazy_12_clean_with_interventions_corrected.npz", "mimic_expert_demonstrations.npz"]:
