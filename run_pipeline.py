...
def main():
    ...
    parser.add_argument("--gpu-type", type=str, default=None, help="Specific GPU model constraint for Slurm GRES (e.g. 'h200', 'rtx4060', 'a100')")
    parser.add_argument("--gres", type=str, default=None, help="Explicit Slurm generic resource string (e.g. 'gpu:1' or 'gpu:4060ti:1')")
    parser.add_argument("--no-gres", action="store_true", default=False, help="Omit --gres line completely (for clusters where partition alone allocates GPU, e.g. -p 4060ti16g)")
