...
METHOD_STYLE = {
    ...
    "cql_blendrl_human_neural":     {"label": "BlendRL (MLP, Human, MLP)", "color": "#ff7f0e", "marker": "s", "linestyle": "-"},
    "blendrl_cql_human_neural":     {"label": "BlendRL (MLP, Human, MLP)", "color": "#ff7f0e", "marker": "s", "linestyle": "-"},
    "cql_blendrl_human_neural_logic": {"label": "BlendRL (MLP, Human, Human)", "color": "#2ca02c", "marker": "^", "linestyle": "--"},
    "blendrl_cql_human_neural_logic": {"label": "BlendRL (MLP, Human, Human)", "color": "#2ca02c", "marker": "^", "linestyle": "--"},
    "cql_blendrl_human_dueling_resnet": {"label": "BlendRL (ResNet, Human, MLP)", "color": "#1f77b4", "marker": "o", "linestyle": "-"},
    "blendrl_cql_human_dueling_resnet": {"label": "BlendRL (ResNet, Human, MLP)", "color": "#1f77b4", "marker": "o", "linestyle": "-"},
    "cql_blendrl_human_dueling_resnet_logic": {"label": "BlendRL (Dueling ResNet, Human, Human)", "color": "#9467bd", "marker": "D", "linestyle": "-."},
    "blendrl_cql_human_dueling_resnet_logic": {"label": "BlendRL (Dueling ResNet, Human, Human)", "color": "#9467bd", "marker": "D", "linestyle": "-."},
